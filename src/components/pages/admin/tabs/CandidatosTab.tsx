...
const CandidatosTab: React.FC = () => {
    ...
    const mockCandidates = [
        { id: '1', name: 'Joaquim Vinícius', phone: '11 99999-9999', updated: '01/01/2025', apps: 20, lastAccess: '01/01/2025' },
        { id: '2', name: 'Alice Jennifer', phone: '11 99999-9999', updated: '01/01/2025', apps: 20, lastAccess: '01/01/2025' },
        { id: '3', name: 'Vitória Francisca', phone: '11 99999-9999', updated: '01/01/2025', apps: 20, lastAccess: '01/01/2025' },
        { id: '4', name: 'Raimundo Caleb', phone: '11 99999-9999', updated: '01/01/2025', apps: 20, lastAccess: '01/01/2025' },
        { id: '5', name: 'Victor Matheus', phone: '11 99999-9999', updated: '01/01/2025', apps: 20, lastAccess: '01/01/2025' },
        { id: '6', name: 'Yago Nascimento', phone: '11 99999-9999', updated: '01/01/2025', apps: 20, lastAccess: '01/01/2025' },
        { id: '7', name: 'Marina Ramos', phone: '11 99999-9999', updated: '01/01/2025', apps: 20, lastAccess: '01/01/2025' },
    ];

    const displayData = candidates.length > 0
        ? candidates.map(c => ({
            id: c.id,
            ...
            apps: 20,
            lastAccess: c.updated_at ? new Date(c.updated_at).toLocaleDateString('pt-BR') : '—',
        }))
        : mockCandidates;
                    ...
                    <tbody>
                        {displayData.map((c, i) => (
                            <tr key={c.id} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                ...
                                <td className="px-6 py-5">
                                    <button
                                        onClick={() => navigate(`/admin/gerenciamento/candidato/${c.id}`)}
