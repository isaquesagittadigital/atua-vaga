        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          {loginType === 'candidate' ? (
            <div>
              ...
              />
              {errors.cpf && <p className="mt-1 text-xs text-red-500 font-medium">{errors.cpf}</p>}
            </div>
          ) : (
            <div>
              ...
              <input
                type="email"
                placeholder="samuel@sagittadigital.com.br"
                value={formData.email}
                onChange={handleEmailChange}
                className={inputClasses}
              />
              {/* Reuse error field or add specific one */}
